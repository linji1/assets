...
<div id="header"> 
<div id="menu_toggle1" onclick="openSearch()"><i class="fa fa-search" style="color: #fff;font-size: 20px;position: absolute;right: 60px;top: 16px;z-index: 9999;height: 50px;"></i></div>
<!-- 搜索框开始 -->
...
<span class="dropbtn" onclick="openDropdown()"><i style="color: #fff;font-size: 20px;position: absolute;right: 20px;top: 16px;z-index: 9999;height: 50px;" class="fa fa-user"></i></span>
...
</div>';} else {echo '<a id="menu_toggle1" href="/index.php?act=login&l="><i style="color: #fff;font-size: 20px;position: absolute;right: 20px;top: 16px;z-index: 9999;height: 50px;" class="fa fa-user"></i></a>';}?>
