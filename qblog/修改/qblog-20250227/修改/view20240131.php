...
<?php include "head.php";?>
  ...
  <div class="breadcrumb"><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" style="
    width: 10px;
    width: 14px;
    height: 14px;
    vertical-align: -2px;
...
<center>
<input type="text" id="text" style="display: none;" value="<?php echo $r[0]; ?>">
<span id="speak" style="border: 0px;cursor: pointer;float: right;padding-right: 20px;color: #7d8c8e;font-size: 12px;/* clear: both; */"><img alt="headphone stoped" aria-hidden="true" class="icon-filled" src="/assets/file/2024/01/headphones_sound_wave_24_filled.svg" style=" width: 20px; vertical-align: middle;opacity: 0.5;"> 收听本文</span>
<script>
if ('speechSynthesis' in window) {
  ...
  speakBtn.addEventListener('click', () => {
    ...
    utterance.text = textInput.value; // 要朗读的文本内容
    utterance.lang = 'zh-CN'; // 设置语言为中文
    utterance.rate = 0.9; // 语速，默认为1.0
