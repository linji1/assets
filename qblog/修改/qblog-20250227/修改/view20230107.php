...
<div style="width: calc(50% - 7px);margin: 0;display: inline-block;background-color: white;  padding: 10px 0px 5px 15px;border-radius: 8px;">
...
<div style="background-color: white;float: right;text-align: right;width: calc(50% - 7px);margin: 0;display: inline-block;padding: 10px 15px 5px 0px;border-radius: 8px;">
