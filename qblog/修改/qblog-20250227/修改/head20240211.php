...
<script type="text/javascript" src="//api.tongjiniao.com/c?_=613193407680258048" async></script>
</head>
<body>
<script>
    function openMenu() {
...
<!-- 登录框结束 -->
<div id="header">
<?php if($tit!=='首页')echo '<div class="cback"><a href="JavaScript:history.back();" title=""><i class="fa" style="color: #888;font-size: 20px;position: absolute;left: 20px;top: 16px;z-index: 9999;height: 50px;font-weight: 600;cursor: pointer;">&#xf053</i></a></div>';?>
...
<div class="dialog-Dropdown-plane">
  ...
  <div class="dropdown-content">
    ...
    <a href="https://jz.linji.cn"><i style="font-size:20px;padding-right: 5px;" class="fa">&#xf157</i></i> 资金明细</a>
