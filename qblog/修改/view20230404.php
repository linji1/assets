...
<div id="article">
<?php if ($v['title']<>"") echo '<h1  id="h1view">'.$title.'</h1>';?><button id="ttsBaiduPlay">语音朗读</button>
<script type="text/javascript">
    ...
    if ('speechSynthesis' in window) {
        ...
        $("#ttsBaiduPlay").on('click', function (e) {
			var text = document.getElementById('printview');
			var res1 = text.innerHTML;
			var h1view = document.getElementById('h1view');
			var res2 = h1view.innerHTML;
			var median = res1.replace(/<\/?.+?>/g,"");
            var res = median.replace(/ /g,""); // res为得到后的内容
