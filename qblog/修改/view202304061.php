...
<?php include "head.php";?>
  ...
  <div class="breadcrumb"><i class="fa fa-map-marker"></i><a href="/" style="padding-left: 5px;color: #7d8c8e;">首页</a>
...
<div  style="cursor: pointer;"><a href="javascript:playPause();" id="music_btn01"><audio id="langdu" controls="" autobuffer="" preload="auto" style="max-width: 50%;opacity: .4;float: right;height: 24px;" title="收听本文">
