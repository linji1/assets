...
<?php include "head.php";?>
  <div id="content">
    ...
    <?php if(empty($list)){ echo '<div class="post_list">没有找到相关记录...</div>';}else{foreach($list as $v){ ?>	 
	  ...
	  <?php if($v['title']<>""){?><a href="<?php echo vurl($v['id']); ?>"><h2 style="border-bottom: 1px dashed #e0e0e0;line-height: 1.5em;font-weight: bold;font-size: 20px;"><?php echo $v['title'];?></h2></a><?php } ?>
      <div class="excerpt">
