...
<!--计时功能代码-->
<b style="display: none;">&nbsp;&nbsp;|&nbsp;&nbsp;Processed <?php
$t2 = microtime(true);
echo round($t2 - $t1, 3) . "s</b>&nbsp;|&nbsp;";
...
function is_crawler() {
    ...
    $known_crawlers = [
        'duckduckbot', 'yandexbot', 'facebot', 'baiduspider', 'sosospider', 'sogou spider', 'yodaobot', 'googlebot', 'bingbot', 'slurp', 'teoma', 'twiceler', 'msnbot', 'scrubby', 'robozilla', 'googlebot-image', 'googlebot-mobile', 'yahoo-mmcrawler', 'yahoo-blogs/v3.9', 'psbot', 'yisouspider', 'swiftbot', 'easouspider', 'yyspider', 'flightdeckreports bot', 'linguee bot', 'applebot', 'mj12bot', 'ahrefsbot', 'seokicks-robot', 'gigabot', 'exabot', 'ia_archiver', 'facebookexternalhit', 'twitterbot', 'linkedinbot', 'pinterestbot', 'outbrain', 'semrushbot', 'dotbot', 'browsershots', 'archive.org_bot', 'rogerbot', 'bytespider'
    ];
    foreach ($known_crawlers as $crawler) {
...
echo "在线人数：" . $maplers . "人";
?>&nbsp;|&nbsp;<a href="https://beian.miit.gov.cn/" rel="nofollow" target="_blank" style="color: #000;"><?php echo $set['icp'];?></a><br><?php require_once 'ip.php'; ?><p>IP地址位置数据由<a href="https://www.cz88.net" target="_blank" style="color: black;">纯真CZ88</a>提供支持</p>
</div>
...
<?php if(ADMIN) echo '<script type="text/javascript" language="javascript" src="assets/js/admin.js"></script>';?>
