...
<?php include "head.php";?>
  ...
  <div class="breadcrumb"><i class="fa fa-map-marker"></i><a href="/" style="padding-left: 10px;color: #7d8c8e;">首页</a>
...
$qian = "https://fanyi.sogou.com/reventondc/synthesis?speed=1&lang=zh-CHS&from=translateweb&speaker=6&text=";
?>
...
if (music.paused) {
music.play();
music_btn.src = 'assets/qblog/images/zanting.png'; //播放图片
var aud = document.getElementById("langdu");
aud.onended = function() {
aud.src = "https://fanyi.sogou.com/reventondc/synthesis?speed=1&lang=zh-CHS&from=translateweb&speaker=6&text="
aud.play();
...
music.pause();
music_btn.src = 'assets/qblog/images/bofang.png'; //暂停图片
}
}
...
<a href="javascript:playPause();"><img src="assets/qblog/images/bofang.png" width="16" height="16" id="music_btn01" border="0"></a>
</span>
