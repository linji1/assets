...
<div id="article">
<?php if ($v['title']<>"") echo '<h1 style="text-align: center;border-bottom: 1px dashed #e0e0e0;padding-bottom: 10px;">'.$title.'</h1>';?>
...
<div class="readall_box">
          ...
          <a class="read_more_btn" target="_self">展开阅读全文 <i class="fa fa-angle-down" aria-hidden="true" style="font-size: 18px; color: #ca0c16;vertical-align:middle;"></i></a>
      </div>
