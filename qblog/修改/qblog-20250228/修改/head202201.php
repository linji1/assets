...
<script>
    ...
    function closeSearch() {
	    ...
	    function openLogin() {
        $(".dialog-Login-plane").addClass("dialog-Login-plane-show");
    }

    function closeLogin() {
        $(".dialog-Login-plane").removeClass("dialog-Login-plane-show");
    }

</script>
<div id="header"> 
<div id="menu_toggle1" onclick="openSearch()"><i class="fa fa-search" style="color: #888;font-size: 20px;position: absolute;right: 60px;top: 16px;z-index: 9999;height: 50px;font-weight: 600;cursor: pointer;"></i></div>
<!-- 搜索框开始 -->
...
<div class="dialog-Dropdown-plane">
  ...
  <div class="dropdown-content">
    <a href="/index.php?act=add"><i style="font-size:16px;" class="fa fa-edit"></i> 发布文章</a>
    <a href="/comment.html"><i style="font-size:16px;" class="fa fa-comment"></i> 文章评论</a>
    <a href="/index.php?act=set"><i style="font-size:16px;" class="fa fa-cog"></i> 全局设置</a>
    <a href="/index.php?act=wid"><i style="font-size:16px;" class="fa fa-wrench"></i> 边栏设置</a>
    <a href="/index.php?act=logout"><i style="font-size:16px;" class="fa fa-power-off"></i> 退出登录</a>
</div>
</div>
</div>';} else {echo '<div id="menu_toggle1" onclick="openLogin()"><i style="color: #888;font-size: 20px;position: absolute;right: 20px;top: 16px;z-index: 9999;height: 50px;font-weight: 300;cursor: pointer;" class="fa fa-user"></i></div>
<!-- 登录框开始 -->
<div class="dialog-Login-plane">
    <div class="dialog-mask" onclick="closeLogin()"></div>
    <div class="dialog-plane">
        <h2>管理员登陆</h2>
        <form class="search-form" action="/index.php?act=dologin" method="post">
            <div class="search-form-input-plane">
                <input type="password" class="search-keyword" name="pass" autocomplete="on" placeholder="输入密码..." required="required" value="">
	   <input name="l" value="" type="hidden">
            </div>
            <div>
                <button type="submit" class="search-submit" alt="登 陆 " value="">登陆</button>
            </div>
