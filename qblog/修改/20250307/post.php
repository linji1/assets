...
<?php include "head.php";?>
  <div id="content" style="position: relative;padding-bottom: 20px;">
    <div id="main1"<?php if($widget=="0") echo ' class="w100"';?> style="background:#fff;padding:15px;box-sizing:border-box;">  
...
<script type="text/javascript" defer language="javascript" src="assets/js/wangeditor/wangEditor.min.js"></script>
<?php if($act ==='edit'){?>
<script type="text/javascript" defer language="javascript" src="assets/js/laydate/laydate.js"></script>
<?php }?>
</body>
</html>