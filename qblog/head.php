...
<div class="dialog-Login-plane1">
    ...
    <div class="dialog-plane1">
        <h2>管理员登陆</h2>
        <form class="search-form1" action="https://linji.cn/index.php?act=dologin" method="post">
...
<div class="dialog-Dropdown-plane">
  ...
  <div class="dropdown-content">
    <a href="https://linji.cn/index.php?act=add"><i style="font-size: 20px;padding-right: 5px;" class="fa fa-edit"></i> 发布文章</a>
   ...
   <a href="/b0/561.html"><i style="font-size:20px;padding-right: 5px;" class="fa">&#xf073</i> 个人信息</a>
    ...
    <a href="https://linji.cn/index.php?act=set"><i style="font-size: 20px;padding-right: 5px;" class="fa fa-cog"></i> 全局设置</a>
    <a href="https://linji.cn/index.php?act=wid"><i style="font-size: 20px;padding-right: 5px;" class="fa fa-wrench"></i> 边栏设置</a>
    <a href="https://linji.cn/index.php?act=logout"><i style="font-size: 20px;padding-right: 5px;" class="fa fa-power-off"></i> 退出登录</a>
</div>
</div>
...
<div class="other-wrap collapse">
	  <div class="other box-m">
	   ...
	   <form method="get" class="search-form" action="https://linji.cn/<?php echo $file;?>"> <input class="search-text" name="s" autocomplete="on" placeholder="输入关键词搜索..." required="required" type="text" value="<?php echo $s;?>"> <button class="search-submit" alt="搜索" type="submit">搜索</button></form>
	   </div>   
</div>
</div>
<div id="wrap"> 